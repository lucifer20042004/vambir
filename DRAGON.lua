...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ TZ ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ TZ ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ TZ ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Bandaa2/TZ/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,bot_id,1373616147,1409176813,1713816440}   
...
if tonumber(user_id) == tonumber(1373616147) then  
var = true  
if tonumber(user_id) == tonumber(1713816440) then  
var = true  
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'المبرمج التونز'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "TZ")
...
local DRAGON_Msg = ''  
if msgs < 100 then 
DRAGON_Msg = 'مش متفاعل' 
elseif msgs < 200 then 
DRAGON_Msg = 'مش اوي في احسن' 
elseif msgs < 400 then 
DRAGON_Msg = 'تفاعلك حلو سيكا' 
elseif msgs < 700 then 
DRAGON_Msg = 'بدأت تتفاعل' 
elseif msgs < 1200 then 
DRAGON_Msg = 'متفاعل اوي' 
elseif msgs < 2000 then 
DRAGON_Msg = 'متفاعل جامد' 
elseif msgs < 3500 then 
DRAGON_Msg = 'احسن تفاعل'  
elseif msgs < 4000 then 
DRAGON_Msg = 'تفاعلك خرافيي' 
elseif msgs < 4500 then 
DRAGON_Msg = 'عااش جامد يستا'
elseif msgs < 5500 then 
DRAGON_Msg = 'احسن تفاعل' 
elseif msgs < 7000 then 
DRAGON_Msg = 'امير التفاعل وربنا' 
elseif msgs < 9500 then 
DRAGON_Msg = 'احسن واحد بيتفاعل' 
elseif msgs < 10000000000 then 
DRAGON_Msg = 'اعلا تفاعل فالروم كلو'  
end 
return DRAGON_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 SOURCE ELTWENZ")  
...
os.execute('wget https://raw.githubusercontent.com/Bandaa2/TZ/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ✵لديك اخر اصدار لسورس التونز\n ✵تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV VAMBAIR✭](t.me/V_a_a_m_b_a_I_r)
[DEV LUSEFAR✭](t.me/LLucifeerr)
[DEV SELVESTR✭](t.me/F_R_3_O_N)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'VAMBAIR BOT', url="t.me/Vambair_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'قناه السورس' or text == 'قناه السورس✭' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[SOURCE ELTWENZ](t.me/T_w_i_n_s_1_1)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/T_w_i_n_s_1_1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/Vambair_bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'BOT VAMBAIR', url="t.me/Vambair_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n ✵ العضو » ['..result.title_..'](t.me/'..(username or 'T_w_i_n_s_1_1')..')'
status  = '\n ✵ تم ترقيته مطور'
...
usertext = '\n ✵ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'T_w_i_n_s_1_1')..')'
status  = '\n ✵ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✵ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'T_w_i_n_s_1_1')..') \n ✵ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ✵ العضو : {["..data.first_name_.."](T.ME/T_w_i_n_s_1_1)}\n ✵ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✵ عذرا » {["..data.first_name_.."](T.ME/T_w_i_n_s_1_1)}\n ✵ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
★WELCOM IN SOURCE ELTWENZ★
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'DEV VAMBAIR★',url="t.me/V_a_a_m_b_a_I_r"}},
{{text = 'LUSEFAR★',url="t.me/LLucifeerr"}},
{{text ='SELVESTR★',url="t.me/F_R_3_O_N"}},
{{text = 'SOURCE CH✭',url="t.me/T_w_i_n_s_1_1"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مين عدلك' then
local Text = [[
WELCOME TO TEEM ELTWENZ✪
✪اهلا بيك مع تيم سورس التوينز♥
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'DEV VAMBAIR✪',url="t.me/V_a_a_m_b_a_I_r"}},
{{text = 'DEV SELVESTR✪',url="t.me/F_R_3_O_N"}}, 
{{text = 'DEV LUSEFAR✪',url="t.me/LLucifeerr"}},
{{text = 'SOURCE ELTWENZ✪',url="t.me/T_w_i_n_s_1_1"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'فرعون' or text == 'سلفستر' then
local Text = [[
DEV SLVESTR✭
]]
keyboard = {} 
...
if text == "تويت★" or text == "كت تويت" or text == "تويت" then 
local TWEET_Msg = { 
"اي اخر فيلم اتفرجت عليه", 
"اخر مرا ضربت امتا", 
"احسن صاحب ليك", 
"اخر اغنية سمعتها ?", 
"تكلم عن نفسك", 
"ليه انت مش سالك", 
"ما هيا عيوب سورس التونز؟ ", 
"تقيمك لسورس التونز كام من10", 
"روايتك المفضله ?", 
"اخر اكله اكلتها", 
"اكلتك المفضله", 
"صاحب الي فضهرك ديما", 
...
"لونك الي بتحبه", 
"لون عيونك", 
"حاجه ندمت انك عملتها", 
"هوايتك المفضله", 
"علاقتك مع اهلك", 
" خدت اي من الدنيا ", 
"حاجه حلوا ", 
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس التونز ؟؟ ", 
" حاجه بتحبها ", 
"حاجه اتخيلتها وحصلت فعلا", 
"شيء عندك اهم من الناس ؟ ", 
"حاجه نفسك توصلها", 
"اكتر واحد مش بتطيقه", 
"اي رايك في سورس التونز ؟ ", 
"كم مره حبيت؟ ", 
" اتخزوقت كام مرا؟", 
" مرطبت ولا سنجل", 
...
if text == 'فامبير' or text == 'فمبير' or text 'المبرمج' then
local Text = [[ 
[DEV VAMBAIR✭](t.me/V_a_a_m_b_a_I_r)
]] 
keyboard = {}  
...
if text == 'العاب التونز' or text == 'العاب خارقه' or text == 'العاب متطوره' then
local Text = [[
TEEM ELTWENZ
]]
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✵ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'T_w_i_n_s_1_1')..') \n ✵ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✵ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'T_w_i_n_s_1_1')..') \n ✵ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " ✪لا يمكنك حظر المبرمج فامبير\n")
return false 
end
if result.sender_user_id_ == tonumber(1409176813) then
send(msg.chat_id_, msg.id_, " ✪لا يمكنك حظر المطور لوسيفر\n")
return false
end
if result.sender_user_id_ == tonumber(1713816440) then
send(msg.chat_id_, msg.id_, " ✪لا يمكنك حظر المطور سلفستر\n")
return false
end
...
if result.sender_user_id_ == tonumber(1373616147) then
send(msg.chat_id_, msg.id_, " ✪لا يمكنك حظر المبرمج فامبير عام\n")
return false 
end
if result.sender_user_id_ == tonumber(1409176813) then
send(msg.chat_id_, msg.id_, " ✪لا يمكنك حظر المطور لوسيفر عام\n")
return false
end
if result.sender_user_id_ == tonumber(1713816440) then
send(msg.chat_id_, msg.id_, " ✪لا يمكنك حظر المطور سلفستر عام\n")
return false
end
usertext = '\n ✵ العضو » ['..result.title_..'](t.me/'..(username or 'T_w_i_n_s_1_1')..')'
status  = '\n ✵ تم حظره عام من الكروبات'
...
if result.sender_user_id_ == tonumber(1409176813) then
send(msg.chat_id_, msg.id_, " ✪لا يمكنك كتم المطور لوسيفر\n")
return false
end
if result.sender_user_id_ == tonumber(1713816440) then
send(msg.chat_id_, msg.id_, " ✪لا يمكنك كتم المطور سلفيستر\n")
return false
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
if result.sender_user_id_ == tonumber(1713816440) then
send(msg.chat_id_, msg.id_, " ✪لا يمكنك كتم المطور سلفستر\n")
return false
end
usertext = '\n ✵ العضو » ['..result.title_..'](t.me/'..(username or 'T_w_i_n_s_1_1')..')'
status  = '\n ✵ تم كتمه عام من الكروبات'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✵ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TZ')..')'
status  = '\n ✵ تم الغاء (الحظر-الكتم) عام من الكروبات'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✵ العضو » '..userid..''
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Bandaa2/TZ/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✵ اهلا بك في متجر ملفات التونز\n ✵ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ TZ ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ TZ ┉  ┉ ┉ ┉ ┉≫ٴ\n ✵ علامة تعني { ✔️ } ملف مفعل\n ✵ علامة تعني { ✖ } ملف معطل\n ✵ قناة سورس التونز ↓\n".." ✵ [اضغط هنا لدخول](t.me/T_w_i_n_s_1_1) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Bandaa2/TZ/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ✵ عذرا الملف لايدعم سورس التونز \n") 
end
return false
end
...
if text == ("مسح قائمه التونز") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ✵ تم مسح قائمه التونز')
return false
end

if text == 'قائمه التونز' and Sudo(msg) then
...
if text == ("رفع التونز") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع التونز @(.*)$") and Sudo(msg) then
local username = text:match("^رفع التونز @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع التونز (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع التونز (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل التونز") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل التونز @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل التونز @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل التونز (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل التونز (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✵ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'T_w_i_n_s_1_1')..')'
status  = '\n ✵ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✵ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✵ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'T_w_i_n_s_1_1')..')'
...
usertext = '\n ✵  العضو » ['..result.title_..'](t.me/'..(username or 'TZ')..')'
status  = '\n ✵  تم رفعه مشرف بكل الصلاحيات'
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✵ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'T_w_i_n_s_1_1')..')'..'\n ✵ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'التونز').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'التونز')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
database:set(bot_id.."TZ:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."TZ:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."TZ:insta_bot"..msg.chat_id_) == "open" then
...
if database:get(bot_id.."TZ:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس التونز يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'التونز').." غادر" or text == 'غادر' then  
...
if text == 'انا مين' or text == '☆انا مين'then
local rtp = Rutba(msg.sender_user_id_,msg.chat_id_)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'T_w_i_n_s_1_1')..')'
local iduser = result.sender_user_id_
...
{
{text = 'SOURCE ELTWENZ', url="t.me/T_w_i_n_s_1_1"},
{text = 'مبرمج السورس', url="t.me/V_a_a_m_b_a_I_r"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ TZ ┉  ┉ ┉ ┉ ┉≫ٴٴ\n✵ [ SOURCE ELTWENZ ](t.me/T_w_i_n_s_1_1)')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'التونز')
...
if text == "صراحه★" or text == "الصراحه" or text == "صراحه" and msg.reply_to_message_id_ ~= 0 and Addictive(msg) then
